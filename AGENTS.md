...
- The full Windows programme contract, `WGO-WIN-SPEC-2`, is owner-authorized
  external material. For `PR-W0.2B.1`, `docs/WINDOWS-PORT-MAP.md` is the sole
  in-repository executable authority for the bounded path-identity foundation
  and living module/import classification.
